    ...
    <div className="absolute inset-0 z-50 flex flex-col justify-center items-center overflow-hidden bg-[#eef2f5]">
      ...
      <div className="relative z-10 flex flex-col items-center animate-fade-in-up w-full px-6">
        ...
        <div className="relative w-32 h-32 mb-6 flex items-center justify-center drop-shadow-lg">
          ...
          <svg className="absolute w-14 h-14 text-[#3b82f6] opacity-30" fill="currentColor" viewBox="0 0 24 24">
            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/>
          </svg>
          
          {/* Rotating Airplane Orbit */}
          <div className="absolute inset-0 animate-[spin_3s_linear_infinite]">
            {/* Dashed Orbit line */}
            <svg className="w-full h-full text-[#64748b] opacity-40" viewBox="0 0 100 100" fill="none">
              <circle cx="50" cy="50" r="48" stroke="currentColor" strokeWidth="1.5" strokeDasharray="8 8"/>
            </svg>
            {/* Airplane Icon tracking the orbit */}
            <svg className="absolute top-0 left-1/2 -ml-[14px] -mt-[14px] w-7 h-7 text-[#1e293b] transform rotate-[90deg] drop-shadow-md" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
