  ...
  return (
    <div className="absolute inset-0 z-50 bg-[#F3EFE6] flex flex-col overflow-y-auto font-['Pretendard'] pb-20 scrollbar-hide">
      ...
      <div className="px-5 py-6 flex flex-col">
        ...
        {/* Title & Location Button Area */}
        <div className="flex justify-between items-start mb-6">
          <div className="flex-1 pr-4">
            <div className="flex items-center gap-2 mb-1">
              <span className="text-[#a39585] text-[0.7rem] font-bold tracking-widest">{photo.island.name}</span>
              {photo.isUser && (
                <span className="bg-[#004790] text-white text-[0.55rem] font-bold px-1.5 py-0.5 rounded-sm">내 사진</span>
              )}
            </div>
            <h2 className="text-[1.4rem] leading-tight font-bold text-[#3e342b] font-['Nanum_Myeongjo'] break-keep">
              {photo.spot.name}
            </h2>
            <p className="text-[#a39585] text-[0.75rem] mt-1.5 font-medium tracking-wide">
          ...
          <button 
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 bg-[#3e342b] text-[#f4ecdf] rounded-full shadow-sm active:scale-95 transition-transform shrink-0 mt-1"
          >
            <span className="text-[0.7rem] font-bold tracking-wide">장소 둘러보기</span>
        ...
        <div className="flex items-center gap-5 mb-5">
          ...
          >
            ...
            <span className="text-[0.85rem] font-semibold">{likesCount}</span>
          </button>
          ...
          <button 
            ...
            className="flex items-center gap-1.5 text-[#8a7a6b] active:scale-95 transition-transform"
          >
            <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"></path><polyline points="16 6 12 2 8 6"></polyline><line x1="12" y1="2" x2="12" y2="15"></line>
            </svg>
            <span className="text-[0.85rem] font-semibold">공유</span>
          </button>
        </div>
