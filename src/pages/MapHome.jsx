...
export default function MapHome() {
  ...
  return (
    <div className="w-full h-full bg-transparent flex flex-col justify-center items-center overflow-hidden">
      
      {/* Container matching the generated image's aspect ratio (square 1:1) */}
      <div className="relative w-full aspect-square max-w-[500px] max-h-[80vh]">
        
        {/* Background Map Image - Contained */}
        <img 
          src={mapBg} 
          alt="옹진군 수채화 지도" 
